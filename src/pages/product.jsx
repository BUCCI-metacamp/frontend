...
export function Product() {
  ...
  useEffect(() => {
    ...
    setCnt(typeof sensorData.passCount === "number" ? sensorData.passCount : 0);
    setFailCnt(
      typeof sensorData.failCount === "number" ? sensorData.failCount : 0
    );
  ...
  // useEffect(() => {
  //   console.log(totalCountLog);
  //   console.log(failRatioLog);
  //   console.log(currentFailRatioLog);
  // }, [totalCountLog]);
            ...
            <div className="grid grid-cols-8 grid-rows-5 gap-5 sm:grid-cols-4 md:grid-cols-8 lg:grid-cols-8 xl:grid-cols-8">
              <Card className="p-5 col-span-2 h-[150px]">
                <div className="flex flex-row gap-3">
                  ...
                  <div className="">
                    <p className="font-bold text-slate-500">양품 :</p>
                    <p className="text-2xl font-bold mt-3">{cnt}</p>
                  </div>
                </div>
                <div className="mt-4">
              ...
              <Card className="p-5 col-span-2 h-[150px]">
                <div className="flex flex-row gap-3">
                  ...
                  <div className="">
                    <p className="font-bold text-slate-500">총 양품 갯수 :</p>
                    <p className="text-2xl font-bold mt-3">{totalCnt}</p>
                  </div>
                </div>
                <div className="mt-4">
                  <p className="text-slate-400">정상</p>
              ...
              <Card className="p-5 col-span-2 h-[150px]">
                <div className="flex flex-row gap-3">
                  <div className="bg-rose-400 h-[70px] w-[10px] rounded-full" />
                  <div className="">
                    <p className="font-bold text-slate-500">불량 :</p>
                    <p className="text-2xl font-bold mt-3">{failCnt}</p>
                  </div>
                </div>
                <div className="mt-4">
                  <p className="text-slate-400">
                    발생 시간 : {formatTime(failWhen)}
                  </p>
                </div>
              </Card>
              <Card className="p-5 col-span-2 h-[150px]">
                <div className="flex flex-row gap-3">
                  ...
                  <div className="">
                    <p className="font-bold text-slate-500">총 불량 갯수 :</p>
                    <p className="text-2xl font-bold mt-3">{totalFailCnt}</p>
                  </div>
                </div>
                <div className="mt-4">
                  <p className="text-slate-400">정상</p>
